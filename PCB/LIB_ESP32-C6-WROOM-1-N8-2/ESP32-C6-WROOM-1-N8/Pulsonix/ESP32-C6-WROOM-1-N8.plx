...
(library Library_1
	...
	(patternDef "ESP32C6WROOM1N8" (originalName "ESP32C6WROOM1N8")
		(multiLayer
			...
			(pad (padNum 30) (padStyleRef s80) (pt -2.755, 0.790) (rotation 90))
			(pad (padNum 31) (padStyleRef s80) (pt -2.755, -0.460) (rotation 90))
			(pad (padNum 32) (padStyleRef s80) (pt -2.755, -1.710) (rotation 90))
			(pad (padNum 33) (padStyleRef s80) (pt -1.505, -1.710) (rotation 90))
			(pad (padNum 34) (padStyleRef s80) (pt -0.255, -1.710) (rotation 90))
			(pad (padNum 35) (padStyleRef s80) (pt -0.255, -0.460) (rotation 90))
			(pad (padNum 36) (padStyleRef s80) (pt -0.255, 0.790) (rotation 90))
			(pad (padNum 37) (padStyleRef s80) (pt -1.505, 0.790) (rotation 90))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt -10.05 5.26) (pt -10.05 5.26) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -10, 5.26) (radius 0.050000000000001) (startAngle 180.0) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -9.95 5.26) (pt -9.95 5.26) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -10, 5.26) (radius 0.050000000000001) (startAngle .0) (sweepAngle 180.0) (width 0.1))
		)
	)
	(symbolDef "ESP32-C6-WROOM-1-N8" (originalName "ESP32-C6-WROOM-1-N8")
	...
	(compDef "ESP32-C6-WROOM-1-N8" (originalName "ESP32-C6-WROOM-1-N8") (compHeader (numPins 37) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ESP32-C6-WROOM-1-N8"))
		(attachedPattern (patternNum 1) (patternName "ESP32C6WROOM1N8")
			(numPads 37)
			(padPinMap
		...
		(attr "Mouser Part Number" "356-ESP32C6WROOM1N8")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Espressif-Systems/ESP32-C6-WROOM-1-N8?qs=8Wlm6%252BaMh8ST02Gmwp74cw%3D%3D")
		(attr "Manufacturer_Name" "Espressif Systems")
		(attr "Manufacturer_Part_Number" "ESP32-C6-WROOM-1-N8")
		(attr "Description" "802.15.4, Bluetooth, WiFi Bluetooth v5.0, Zigbee Transceiver Module 2.4GHz PCB Trace Surface Mount")
		(attr "<Hyperlink>" "https://www.espressif.com/sites/default/files/documentation/esp32-c6-wroom-1_datasheet_en.pdf")
		(attr "<Component Height>" "3.25")
		(attr "<STEP Filename>" "ESP32-C6-WROOM-1-N8.stp")
